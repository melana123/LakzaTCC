...
public static class TranslateIdentityErrors
{
    public static string TranslateErrorMessage(string codeError)
    {
        string message = codeError switch 
        {
           ...
           "DuplicateEmail" => "Este email já esta sendo utilizado",
           "InvalidRoleName" => "Esta permissão é invalida",
           ...
           "UserAlreadyHasPassword" => "Usuário já possui senha definida",
           "PasswordMismatch" => "Senha incorreta",
           "PasswordTooShort" => "Senha muito curta",
           "PasswordRequiresNonAlphanumeric" => "Senhas devem conter pelo menos um caracter não alfanumérico",
